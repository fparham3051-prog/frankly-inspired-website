/* ==========================================================================
   ...
   and revenue-growth-score.js for the same standard applied to those tools):
   ...
   page's organizing frame, and pulls in this visitor's saved Revenue &
   Growth Score (fi_revenue_growth_score) and Leadership & Operations Score
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderTriangle(strategyPct, strategyBand) {
    // 'fi_financial_score' was this key's name before the tool was renamed
    // from "Financial Health Score" to "Revenue & Growth Score" — falling
    // back to it here means a visitor who took the tool before the rename
    // doesn't lose their saved leg.
    var revenueGrowth = readSavedScore('fi_revenue_growth_score') || readSavedScore('fi_financial_score');
    ...
    var legs = [
      ...
      },
      {
        ...
        note: revenueGrowth ? 'From your Revenue & Growth Score' : null,
        score: revenueGrowth ? revenueGrowth.score : null,
        band: revenueGrowth ? revenueGrowth.band : null,
        available: !!revenueGrowth,
        cta: { href: 'revenue-growth-score.html', label: 'Take the Revenue & Growth Score' },
      },
    ];
    ...
    return { revenueGrowth: revenueGrowth, leadership: leadership };
  }
  ...
  function renderResults() {
    ...
    if (triangleData.revenueGrowth) { legScores.push(triangleData.revenueGrowth.score); }
    ...
    var summaryPrefix = legScores.length === 3
      ? 'Blended from all three tools — strategy, revenue and growth capacity, and leadership capacity. '
